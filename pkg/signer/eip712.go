...
func l1Domain() apitypes.TypedDataDomain {
	return apitypes.TypedDataDomain{Name: "Exchange", Version: "1", ChainId: math.NewHexOrDecimal256(chainIDL1), VerifyingContract: zeroAddress}
}
...
func userActionDomain() apitypes.TypedDataDomain {
	return apitypes.TypedDataDomain{Name: "HyperliquidSignTransaction", Version: "1", ChainId: math.NewHexOrDecimal256(chainIDUserSigned), VerifyingContract: zeroAddress}
}
...
func userActionTypedData(typeName string, typeFields []apitypes.Type, message map[string]any, isMainnet bool) apitypes.TypedData {
	...
	return apitypes.TypedData{Types: apitypes.Types{"EIP712Domain": eip712DomainType, typeName: typeFields}, PrimaryType: typeName, Domain: userActionDomain(), Message: msg}
}
